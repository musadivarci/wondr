...
export function TopicsPage({ topics, visibleTopics, studyHistory, studyItems, showArchived, searchTerm, sortMode, onSearchChange, onSortChange, onToggleArchiveView, onNewTopic, onOpenCategories, onOpenStudyItems, onDragStart, onDragOver, onDrop, onDragEnd, onStudy, onEdit, onArchive }: TopicsPageProps) {
  ...
  return <main className="topics" id="topics">
    ...
    {topics.length === 0 && !showArchived ? <section className="empty-home" aria-label="Boş konu durumu">
      ...
      <div className="empty-home-actions"><button className="study-button" type="button" onClick={onNewTopic}>+ İlk konunu oluştur</button><button className="archive-toggle" type="button" onClick={onOpenCategories}>Kategori ağacını kur</button></div>
    </section> : <>
      ...
      <div className="topic-toolbar">
        ...
        <div className="toolbar-actions">
          ...
          <button className="archive-toggle" type="button" onClick={onOpenCategories}>Kategoriler</button>
